...
(function() {
  ...
  __t('toaster').Toast = (function() {
    ...
    function Toast(toaster) {
      ...
      this.toast = function(srcpath, params) {
        if (params == null) {
          params = {};
        }
        return Toast.prototype.toast.apply(_this, arguments);
      };
  ...
  __t('toaster.core').Builder = (function() {
    ...
    function Builder(toaster, cli, config) {
      ...
      this.cli = cli;
      this.config = config;
      this.merge_vendors = function() {
        return Builder.prototype.merge_vendors.apply(_this, arguments);
      };
      this.on_fs_change = function(src, ev, f) {
        return Builder.prototype.on_fs_change.apply(_this, arguments);
      };
      this.build = function(header_code, footer_code) {
        if (header_code == null) {
          header_code = "";
        }
        if (footer_code == null) {
        ...
        return Builder.prototype.build.apply(_this, arguments);
      };
  ...
  __t('toaster.generators').Config = (function(_super) {
    ...
    function Config(basepath) {
      ...
      this.write = function(src, release, httpfolder) {
        return Config.prototype.write.apply(_this, arguments);
      };
      this.create = function() {
        return Config.prototype.create.apply(_this, arguments);
      };
    }
  ...
  __t('toaster.generators').Project = (function(_super) {
    ...
    function Project(basepath) {
      var _this = this;
      this.basepath = basepath;
      this.scaffold = function(target, src, release, httpfolder) {
        return Project.prototype.scaffold.apply(_this, arguments);
      };
    }
